...
customer_service_agent = Agent[TelcoAgentContext](
    ...
    instructions=(
        ...
        "Only prompt them to provide the information if it is not available. If the information already exists, do not change any of it. "
        "If the customer provides information about a new name or phone number, direct them to start a new conversation instead. "
